  ...
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <h1 className="text-6xl text-white font-black mt-20">
        Seu <span className='bg-gradient-to-r from-yellow-500 via-red-600 to-orange-500 bg-clip-text text-transparent'>duo</span> está aqui.
      </h1>
      ...
      <div className="pt-1 bg-gradient-to-r from-yellow-500 via-red-600 to-orange-500 self-stretch rounded-lg overflow-hidden mt-8">
        <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
          ...
          <button className="py-3 px-4 hover:bg-orange-500 text-white rounded flex items-center gap-3">
