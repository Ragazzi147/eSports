...
class Server {
  ...
  {var _this5 = this;return _asyncToGenerator(function* () {
      ...
      if (pathname.match(/\.bundle$/)) {
        yield _this5._processBundleRequest(req, res);
      } else if (pathname.match(/\.map$/)) {
        yield _this5._processSourceMapRequest(req, res);
      } else if (pathname.match(/\.assets$/)) {
        yield _this5._processAssetsRequest(req, res);
      } else if (pathname.match(/\.delta$/)) {
        yield _this5._processDeltaRequest(req, res);
      } else if (pathname.match(/^\/onchange\/?$/)) {
        _this5._processOnChangeRequest(req, res);
      } else if (pathname.match(/^\/assets\//)) {
        yield _this5._processSingleAssetRequest(req, res);
      } else if (pathname === '/symbolicate') {
        _this5._symbolicate(req, res);
      } else if (next) {
        next();
      } else {
        res.writeHead(404);
