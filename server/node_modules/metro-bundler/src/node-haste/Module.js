...
class Module {
  ...
  _getTransformedCode(
  cacheProps)
  {var _this6 = this;return _asyncToGenerator(function* () {const
      _globalCache = _this6._globalCache;
      ...
      return yield _this6._transformAndStoreCodeGlobally(cacheProps, _globalCache);})();
  }
  ...
  readFresh(transformOptions) {var _this8 = this;
    ...
    const freshPromise = _asyncToGenerator(function* () {
      ...
      _this8._readResultsByOptionsKey.set(key, {
        result: finalResult,
        outdatedDependencies: [] });
