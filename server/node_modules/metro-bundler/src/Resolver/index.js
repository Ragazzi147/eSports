...
require('../Bundler/source-map');const compactMapping = _require.compactMapping,fromRawMappings = _require.fromRawMappings,toRawMappings = _require.toRawMappings;
...
class Resolver {
  ...
  {let path = _ref6.path,getModuleId = _ref6.getModuleId,dependencyPairs = _ref6.dependencyPairs,dependencyOffsets = _ref6.dependencyOffsets,name = _ref6.name,code = _ref6.code;var _ref6$dev = _ref6.dev;let dev = _ref6$dev === undefined ? true : _ref6$dev;
