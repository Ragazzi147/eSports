...
class Replacement {constructor() {this.
    nameToIndex = new Map();this.
    dependencies = [];this.
    replaceImports = true;}
  ...
  getIndex(stringLiteralOrTemplateLiteral, isAsync) {
...
class ProdReplacement {
  ...
  constructor(dependencies) {this.replaceImports = false;
