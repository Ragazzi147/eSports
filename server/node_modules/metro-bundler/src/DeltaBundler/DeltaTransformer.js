...
class DeltaTransformer extends EventEmitter {
  ...
  bundleOptions)
  {
    ...
    if (this._bundleOptions.dev) {params.push(name);}return addParamsToDefineCall.apply(undefined, [code].concat(params));} /**
                                                                                                                             ...
                                                                                                                             */_wrapAsset(_ref9) {var _this10 = this;let code = _ref9.code,dependencyPairs = _ref9.dependencyPairs,name = _ref9.name,path = _ref9.path;return _asyncToGenerator(function* () {const asset = yield _this10._bundler.generateAssetObjAndCode(path, _this10._bundleOptions.assetPlugins, _this10._bundleOptions.platform);return yield _this10._resolver.wrapModule({ path, getModuleId: _this10._getModuleId, dependencyPairs, dependencyOffsets: asset.meta.dependencyOffsets, name, code: asset.code, dev: _this10._bundleOptions.dev });})();}_getModuleType(module) {if (module.isAsset()) {return 'asset';}if (module.isPolyfill()) {return 'script';}return 'module';}_getMetadata(module, transformOptions) {return _asyncToGenerator(function* () {return yield module.read(removeInlineRequiresBlacklistFromOptions(module.path, transformOptions));})();}}module.exports = DeltaTransformer;