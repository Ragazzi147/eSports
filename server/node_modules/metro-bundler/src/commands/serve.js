...
require('../cli-utils');const findMetroConfig = _require.findMetroConfig,makeAsyncCommand = _require.makeAsyncCommand;
...
exports.handler = makeAsyncCommand((() => {var _ref = _asyncToGenerator(function* (argv) {
    argv.config = yield findMetroConfig(argv.config);

    yield MetroApi.runServer(_extends({},
    argv, {
      onReady(server) {
        console.log(
